...
//	error_reporting(0);
	...
	if ( $_SESSION["lang"] == "english" )
		...
		$Json_File = "../lib/lang/" . $_SESSION["lang"] . "/data.json";
	// Read our json file
...
<?php
	...
	if ( !empty( $JsonData['desc_md'] ) && $JsonData['desc_md'] == "true" )
	{
		...
		if ( $_SESSION["lang"] == "english" )
			...
			$file = '../lib/lang/' . $_SESSION["lang"] . '/markdown/' . strtolower( $filename ) . '.md';
		if ( file_exists( $file ) )
...
<?php
	...
	if ( !empty( $JsonPageData['desc_md'] ) && $JsonPageData['desc_md'] == "true" )
	{
		...
		if ( $_SESSION["lang"] == "english" )
			...
			$file = '../lib/lang/' . $_SESSION["lang"] . '/markdown/' . strtolower( $FunctionName ) . '.md';
		if ( file_exists( $file ) )
